...
\centering
\begin{tabular}{ccc}
\scalebox{0.14}{\includegraphics{\picdir/MeshTemplate.png}} &
\scalebox{0.14}{\includegraphics{\picdir/MeshTemplate.png}} &
\scalebox{0.14}{\includegraphics{\picdir/MeshTemplate.png}} \\
(a) & (b) & (c) \\
\end{tabular}
\caption{ Wavelength Sensitivity.
(a) The model of the laser applicator is registers to the prostate
data set shown in Figure~\ref{SpatialBasis}.
The predicted sensitivity at (b) $\lambda = 750nm $ and (c) $\lambda = 850nm $ 
is shown.
