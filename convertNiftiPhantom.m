...
for iii = 1:size(exampledata.Wavelength,2)
  ...
  savevtkcmd = ['c3d  padata.' sprintf('%04d',iii) '.nii.gz phantomlabel.nii.gz -multiply -o padata.' sprintf('%04d',iii) '.vtk; sed -i ''s/scalars/padata/g'' padata.' sprintf('%04d',iii) '.vtk']
  disp(savevtkcmd);
end
...
phantomlabel   = '/opt/apps/itksnap/c3d-1.0.0-Linux-x86_64/bin/c3d -verbose  bmode_ATROPOS_GMM.nii.gz -thresh 1 1 1 0 -connected-components -threshold 1 1 1 0  -dilate 1 5x5x5vox -o phantomlabel.nii.gz'
