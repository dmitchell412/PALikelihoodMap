...
nsource    = 10;
xloc       = spacingX*linspace(1,nsource ,nsource )+1.e-4;
yloc       = spacingY*linspace(1,nsource ,nsource )+1.e-4;
zloc       = spacingZ*linspace(1,nsource ,nsource )+1.e-4;
u_artery   = 37.;
c_blood    = 3480.;
power      = 10.;
...
%%  plot
imagesc(h_temperature(:,:,5), [37 100]);
colormap default
colorbar
